...
"~/Imperial College London/HIV Inference Group - WP - Documents/Data/household surveys/PHIA/datasets/CIV/datasets/102 CIPHIA 2017-2018 Household Dataset (DTA).zip"
